    ...
    return Scaffold(
      ...
      body: Consumer<NoteProvider>(
        builder: (context, noteProvider, child) {
          ...
          final notesWithReminders = noteProvider.notesWithReminders;
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                Text(
                  '${notesWithReminders.length} reminder${notesWithReminders.length == 1 ? '' : 's'}',
                ...
                const SizedBox(height: 16),
                _buildNotesGrid(notesWithReminders),
              ],
            ),
          );
        },
